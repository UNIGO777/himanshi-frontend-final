  ...
  return (
    <section className="py-10">
      ...
      <div className="rounded-3xl bg-brand-100 p-6 sm:p-8">
        ...
        <div className="mt-6 grid gap-8 lg:mt-8 lg:grid-cols-2 lg:items-start">
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.35 }}
            transition={{ duration: 0.45 }}
            className="overflow-hidden rounded-3xl border border-slate-900/10 bg-white/70"
          >
            <img
              className="h-56 w-full object-cover sm:h-64"
              src="https://images.unsplash.com/photo-1558490937-511ddc4b9a56?auto=format&fit=crop&w=1600&q=80"
              alt="Homes in Shimla, India"
              loading="lazy"
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.35 }}
            transition={{ duration: 0.45 }}
            className="rounded-3xl bg-brand-900 p-6 text-white sm:p-7"
          >
